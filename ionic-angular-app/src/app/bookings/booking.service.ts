...
export class BookingService {
    ...
    addBooking(placeId: string, title: string, image: string, firstName: string, lastName: string, guestNo: number, dateFrom: Date, dateTo: Date) {
        ...
        // 2nd arg: copy the newBooking created above & override id as null so the one generated by firebase is used
    ...
    fetchBookings() {
        ...
        return this.http.get<{[key: string]: BookingData}>(
            `https://pairbnb-app.firebaseio.com/bookings.json?orderBy="userId"&equalTo="${this.authService.userId}"`)
        .pipe(
            map(bookingData => {
            const bookings = [];
