...
export class LocationPickerComponent implements OnInit {
  ...
  private showErrorAlert() {
    this.alertCtrl.create({header: 'Could not fetch location', message: 'Please use the map to pick a location!', buttons: ['Okay']})
    .then(alertEl => {
      alertEl.present();
    });
  }
  ...
  // function that uses geocoding API (need to be enabled) to obtain address
  // upon clicking a location on the google maps
  ...
  // generates a screenshot from google maps of given location on map
